# Zadanie 7: Selekcja Imion

Stwórz tablicę z 5 imionami. Napisz funkcję `pokazDlugieImiona(tablicaImion)`, która wypisze tylko te imiona, które mają więcej niż 5 liter.

### Podpowiedzi:
- Wykorzystaj pętlę i instrukcję warunkową.
- Długość tekstu sprawdza się tak samo jak długość tablicy.
