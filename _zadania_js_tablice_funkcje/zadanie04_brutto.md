# Zadanie 4: Generator Ceny Brutto

Masz tablicę `cenyNetto = [100, 200, 50]`. Napisz funkcję `drukujBrutto(tablicaNetto)`, która dla każdego elementu obliczy cenę z 23% VAT i wyświetli ją.

### Podpowiedzi:
- Wzór: cena brutto = cena netto * 1.23.
- Wykorzystaj `document.write` bezpośrednio w pętli wewnątrz funkcji.
