# Zadanie 8: Manipulacja kolejnością

Stwórz funkcję `odwrocKolejnosc(tablica)`, która wypisze elementy tablicy od ostatniego do pierwszego (nie używaj gotowych funkcji odwracających).

### Podpowiedzi:
- Pętla `for` może odliczać w dół.
- Startuj od `length - 1`, kończ na 0.
