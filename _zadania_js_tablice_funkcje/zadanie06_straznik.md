# Zadanie 6: Strażnik Temperatury

Mamy temperatury z tygodnia: `[15, 18, 21, 19, 25, 17, 16]`. Napisz funkcję `znajdzNajwyzsza(tablica)`, która znajdzie i zwróci największą liczbę.

### Podpowiedzi:
- Załóż, że pierwszy element jest największy.
- W pętli porównuj go z każdym kolejnym elementem. Jeśli znajdziesz większą liczbę – zaktualizuj swój wynik.
